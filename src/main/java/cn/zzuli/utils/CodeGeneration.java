...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc =
                new DataSourceConfig.Builder("jdbc:mysql:///erp?&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","root")
        ...
        GlobalConfig global = new GlobalConfig.Builder()
                ...
                .commentDate("2024年7月10日")//格式化时间格式
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("cn.zzuli")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
...
//            .build();
        ...
        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                ...
                .addTablePrefix("tb_", "sys_","bus_","rel_","hup_") //设置忽略表前缀
